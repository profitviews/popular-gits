...
parser.add_argument('--log', '-l', help=f"Specify the log level.  Default is {logging.getLogger().__dict__['level']}")

if __name__ == "__main__":
    args = parser.parse_args()
    logger = logging.getLogger()
    logger.setLevel(int(args.log) if args.log else logging.INFO)
